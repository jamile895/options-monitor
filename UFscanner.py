...
# =========================
with st.expander("📖 Manuale — Options Flow Scanner PRO v4.1.6"):
    st.markdown("""
## 🎯 Obiettivo del Tool
...
# SCAN BUTTON
# =========================
if st.button("🚀 Scansiona mercato", type="primary", width='stretch'):
    ...
    if not final_df.empty:
        ...
        # Rinomina bid/ask con ~ per indicare che sono stime
